...
% Define Maroon locally or rely on it if added to the .sty palette
...
%------------------------------------------------------------
% PRESENTATION METADATA (Completely Automated)
%------------------------------------------------------------
...
\begin{frame}[fragile]{Some maths}
  ...
  \[\mathcolor{spanish-red}{y \mid \bm\theta \sim \dpois(\bm\theta)}\] 
